...
namespace Branching_Assignment
{
    class Program
    {
        static void Main()
        {
            ...
            else if (p_height + p_length + p_width > 50)
            {
                Console.WriteLine("package is too big to be shipped via Package Express.");
            }
            else
            {
                double quote = p_width * p_height * p_length / 100; // if all dimensions fall under max, multiply within themselves and divide by 100 to get price.
