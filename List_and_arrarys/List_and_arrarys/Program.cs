...
namespace List_and_arrarys
{
    class Program
    {
        ...
        {
            string[] brands = { "nike", "jordan", "adidas" }; // created an array of strings
            Console.WriteLine("pick a number less than 3, including zero");
            int answer = Int32.Parse(Console.ReadLine()); // created var for user input and used method to link result with index
            if (answer == 0)    // created an if statement to check for given index correlation if exists.
            {
            ...
            int[] amounts = { 10, 20, 30, 40, 50, 60 }; // created an array of integers
            Console.WriteLine("Select a number less than 5, also including 0."); // created var for user input and used method to link result with index
            int response = Int32.Parse(Console.ReadLine()); // created an if statement to check for given index correlation if exists.
            if (response == 0)
            {
            ...
            List<string> colors = new List<string>() { "red", "blue", "green", "yellow" }; // created list of strings
            Console.WriteLine("Pick another number less than 4"); // ask user to pick number
            int pick = Int32.Parse(Console.ReadLine()); // find match response with index
